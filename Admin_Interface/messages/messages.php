        ...
        <div class="home-content">
          ...
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title">List of Messages</div>
              <div class="sales-details">
                <ul class="details">
                  ...
                  ?>
                        <li id="myTable"><a href="view-message.php?fullname=<?php echo $items['fullname']?> &email=<?php echo $items['email']?> &msg=<?php echo $items['msg']?> &dateofmsg=<?php echo $items['dateofmsg']?>"><?= ucwords($items['dateofmsg']) ?></a></li>
                    <?php
                      }
                    }
                  ?>  
                ...
                <?php
                    ...
                    foreach($query_run as $items) {
                ?>
                  <li id="myTable"><a href="view-message.php?fullname=<?php echo $items['fullname']?> &email=<?php echo $items['email']?> &msg=<?php echo $items['msg']?> &dateofmsg=<?php echo $items['dateofmsg']?>"><?= ucwords($items['fullname']) ?></a></li>
                  <?php 
                      }
                    }
                ?> 
              ...
              <ul class="details">
                ...
                <?php
                    ...
                    foreach($query_run as $items) {
                ?>
                <li id="myTable"><a href="#" style='cursor: default;'> ... </a></li>
                <?php 
                      }
                    }
                ?> 
