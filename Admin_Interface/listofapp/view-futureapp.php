...
if(isset($_POST['cancelapp'])){
  ...
  echo '<script>alert("You have cancel an appoinment")</script>';
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="view-futureapp.css">
    ...
    <div class="sidebar">
        <div class="logo-details">
          ...
          <ul class="nav-links">
            ...
            <li>
              <a href="../listofapp/listofappointment.php" class="active">
      ...
      <section class="home-section">
        <nav>
          <div class="sidebar-button">
            ...
            <span class="dashboard">Future Appointment</span>
          </div>
        ...
        <div class="home-content">
            <div class="overview-boxes">
                ...
                <a href="listofappointment.php" class="backBton">back</a>
          ...
          <div class="sales-boxes">
            ...
            <div class="recent-sales box">
              <div class="title">Future Appoinment</div>
                ...
                <form action="" method="POST">
                    ...
                    <tbody>
                     <tr>
                      ...
                      <td class="btn"> 
                        <input type="hidden" name="reference" value="<?php echo $_GET['reference'] ?>">
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal1" style="margin-top: 10px">
                          Cancel
                        </button>
...
<script src="view-futureapp.js"></script>
