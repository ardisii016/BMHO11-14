...
$retrieved = $_POST['retrieve'];
$email = $_GET['email'];

$conn = mysqli_query ($conn,"UPDATE `registration` SET usertype ='$retrieved' WHERE email = '$email'");

echo '<script>alert("You have retrieved this account")</script>';
}
...
<link rel="stylesheet" href="view-archived.css">
...
<div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="../archivedacc/archived.php" class="active">
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <a href="archived.php" class="backBton">back</a>
            ...
            <div class="row-container">
              ...
              <div class="input-group">
                ...
                <div class="right-side">
                    ...
                    <button type="button" class="delete btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-top:5px; padding:4px 10px; font-size:15.5px; border:black solid 1px">
                      Retrieve
                    </button>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Retrieve Account</h5>
                        ...
                        <div class="modal-footer">
                          <button type="submit" class="bx bx-check-circle" name="retrieve" value="user" style="border:none; background:none; font-size:30px;" title="Retrieve this account?">
                          </button>
...
<script src="view-archived.js"></script>
