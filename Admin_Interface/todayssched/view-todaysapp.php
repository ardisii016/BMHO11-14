...
if(isset($_POST['doneapp'])){
  ...
  $conn = mysqli_query ($conn,"UPDATE `appointment` SET status ='$done' WHERE reference = '$reference'");

  echo '<script>alert("This appointment is now done")</script>';
}
...
if(isset($_POST['cancelapp'])){
  ...
  echo '<script>alert("You have cancel an appointment")</script>';
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="view-todaysapp.css">
      ...
      <section class="home-section">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                ...
                <a href="todayssched.php" class="backBton">back</a>
                     ...
                     <tr>
                      ...
                      <td> 
                        ...
                        <!-- Button trigger modal -->
                          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-top:10px; padding:4px; font-size:12.5px">
                          Done
                        </button>
                       </td>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Is this appointment already done?
                            </div>
                            <div class="modal-footer">
                              <button type="submit" class="bx bx-check-circle" name="doneapp" value="done" style="border:none; background:none" title="Is this already done?">
                              </button>
                            </div>
                          </div>
                        </div>
                      ...
                      <td> 
                        <input type="hidden" name="reference" value="<?php echo $_GET['reference'] ?>">
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal1" style="margin-top: 10px; margin-left: 10px; padding:4px; font-size:12.5px">
                          Cancel
                        </button>
                      </td>
                      </tr>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="submit" class="bx bx-x-circle" name="cancelapp" value="cancel" style="border:none; background:none" title="cancel this appointment?">
                              </button>
                            </div>
                          </div>
                        </div>
...
<script src="view-todaysapp.js"></script>
