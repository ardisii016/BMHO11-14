...
<head>
    ...
    <link rel="stylesheet" href="view-done.css">
    ...
    <div class="sidebar">
        <div class="logo-details">
          ...
          <ul class="nav-links">
            ...
            <li>
              <a href="../doneapp/doneappointment.php" class="active">
      ...
      <section class="home-section">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                ...
                <a href="doneappointment.php" class="backBton">back</a>
                
              </div>
    
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title">Done Appoinment</div>
...
<script src="view-done.js"></script>
